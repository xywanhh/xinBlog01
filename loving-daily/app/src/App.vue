...
document.title += getDateDiff((new Date()).getFullYear() + '-' + ((new Date()).getMonth() + 1) + '-' + (new Date()).getDate(), '2019-02-11') + 1 + '天';
export default {
    name: 'app',
    components: {
        StyleEditor,
...
2019年02月11日。初初相识。  
已有 \`${getDateDiff((new Date()).getFullYear()+'-'+((new Date()).getMonth()+1)+'-'+(new Date()).getDate(),'2019-02-11') + 1}\` 天
